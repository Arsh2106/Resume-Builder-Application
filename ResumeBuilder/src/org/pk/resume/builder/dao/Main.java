...
public class Main {
	...
	public static void main(String[] args) {
		...
		p.setDob("1999-02-12");
		p.setAge("21");
		p.setAddress("Batchu Naga Mahitha");
		p.setEmailId("mahi@gmail.com");
		p.setGender("FEMALE");
		p.setLangaugeProf("Telugu, English, Hindi");
		...
		exp.setExperience("2 years");
		exp.setJoiningDate("2018-02-1");
		exp.setLeavingDate("2021-04-1");
